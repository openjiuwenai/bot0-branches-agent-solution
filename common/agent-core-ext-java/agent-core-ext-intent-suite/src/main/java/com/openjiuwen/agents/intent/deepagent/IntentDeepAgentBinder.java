...
public final class IntentDeepAgentBinder {
    private static final Logger log = LoggerFactory.getLogger(IntentDeepAgentBinder.class);
    ...
    public void bind(DeepAgent deepAgent, IntentSuite suite) {
        ...
        synchronized (bindings) {
            ...
            log.info("Intent suite bound to DeepAgent agentType={} toolName={} catalogVersion={}",
                    deepAgent.getAgent().getClass().getName(), IntentRoutingRail.TOOL_NAME, suite.snapshot().version());
        }
    }
}
