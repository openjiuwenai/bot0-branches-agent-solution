...
public final class DefaultIntentInitializer implements IntentInitializer {
    ...
    public InitializedIntents initialize(IntentSuiteConfig config, IntentCatalogInput catalog) {
        ...
        log.info("Intent catalog initialized agentCards={} customIntents={} matchableIntents={} fallback={}",
                catalog.agentCards().size(), catalog.customIntents().size(), definitions.size(), fallback != null);
