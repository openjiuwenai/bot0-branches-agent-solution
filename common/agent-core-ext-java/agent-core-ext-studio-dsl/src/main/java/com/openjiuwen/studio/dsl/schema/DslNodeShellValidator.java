...
public final class DslNodeShellValidator {
    ...
    public static void validateRaw(Map<String, Object> raw) {
        ...
        if (id == null || String.valueOf(id).isBlank()) {
            throw new NodeExecutionException("n/a", String.valueOf(type), NodeCauseCode.NODE_CONFIG_INVALID, "id required");
        }
        if (type == null || String.valueOf(type).isBlank()) {
            throw new NodeExecutionException(String.valueOf(id), "unknown", NodeCauseCode.NODE_CONFIG_INVALID, "type required");
        }
