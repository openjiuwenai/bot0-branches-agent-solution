 ...
 *
 * <p>Asserts that the {@code com.openjiuwen.rdc.spi..} packages stay pure Java:
 ...
 * CLAUDE.md Rule R-I sub-clause .b.
 *
...
class AgentRdcSpiPurityTest {
    /**
     * Production SPI classes only ({@code com.openjiuwen.rdc.spi} and
    ...
    private static final JavaClasses SPI_PRODUCTION = new ClassFileImporter()
            ...
            .importPackages("com.openjiuwen.rdc.spi");

    @Test
    void spi_does_not_import_spring() {
        noClasses()
                .that().resideInAPackage("com.openjiuwen.rdc.spi..")
