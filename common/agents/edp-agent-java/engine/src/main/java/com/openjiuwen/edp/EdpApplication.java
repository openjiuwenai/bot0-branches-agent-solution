 ...
 *     <li>{@code com.openjiuwen.edp} - EDPAgent 自身 Bean</li>
 * </ul>
 *
 * @since 2026-01-01
 */
...
@SpringBootApplication(scanBasePackages = {"com.openjiuwen.service.app.autoconfigure",
        ...
        "com.openjiuwen.service.adapters.agentcore.ext.autoconfigure", "com.openjiuwen.edp"})
