            ...
            "properties": {
                "query_description": {
                    ...
                    "description": (
                        ...
                        "'从尾号3344的卡转账30000元到尾号为6605的卡'、"
                            "'购买理财产品：产品名称：示例理财产品，产品代码：PRD0001，金额：10000元'"
                    ),
                },
                "query_intent": {
                    "type": "string",
                ...
                "input_key": {
                    ...
                    "description": (
                        ...
                        "用于从后台通道读取前序工作流的输出数据，注入到当前脚本的 SKILL_INPUT['input_data']。"
                        "⚠️ 必须与前序脚本输出的 result_key 严格匹配（大小写敏感）。"
                        "示例：前序脚本输出 result_key='fund_recommend_result'，则 input_key='fund_recommend_result'。"
