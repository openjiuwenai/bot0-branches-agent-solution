...
class TestHeartbeatEventModel:
    ...
    def test_heartbeat_data_accepts_contract_fields(self):
...
class TestHeartbeatEventRegistration:
    ...
    def test_heartbeat_in_agent_event_union(self):
    ...
    def test_heartbeat_in_event_type_map(self):
    ...
    def test_event_type_map_roundtrip(self):
