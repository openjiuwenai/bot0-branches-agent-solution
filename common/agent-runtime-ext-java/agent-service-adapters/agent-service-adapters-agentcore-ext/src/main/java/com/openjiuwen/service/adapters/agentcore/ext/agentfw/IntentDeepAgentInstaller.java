...
public final class IntentDeepAgentInstaller {
    ...
    public void install(Object agent) {
        ...
        synchronized (installed) {
            ...
            log.info("Installed intent routing on DeepAgent agentType={} exposeAgentCardTools={} catalogVersion={}",
                    deepAgent.getAgent().getClass().getName(), exposeAgentCardTools, suite.snapshot().version());
        }
    }
