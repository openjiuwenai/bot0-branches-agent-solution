...
package com.openjiuwen.example.deepresearch.agent.port;
 ...
 *
 * @param isOk whether the execution succeeded (exit code 0 and no transport error)
 ...
 * @since 2026-07-06
 */
public record ExecResult(boolean isOk, int exitCode, String stdout, String stderr, String message) {
    /**
