...
java -jar target/customer-agent-app-1.0.0.jar \
  --edpa.agent.scenario-home=./scenarios/abc-loan-scenario
```
...
**Q: 如何切换场景？**
A: 修改 `application.yml` 的 `scenario-home`，或通过命令行参数 `--edpa.agent.scenario-home=./scenarios/abc-loan-scenario` 覆盖。
