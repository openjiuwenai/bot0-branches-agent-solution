...
public class DirectChainProperties {
    ...
    public Set<String> getA2aForwardAgentCards() { return a2aForwardAgentCards; }
    public void setA2aForwardAgentCards(Set<String> a2aForwardAgentCards) { this.a2aForwardAgentCards = a2aForwardAgentCards; }
    public Duration getTimeout() { return timeout; }
    public void setTimeout(Duration timeout) { this.timeout = timeout; }
    public boolean isRawPassthrough() { return rawPassthrough; }
    public void setRawPassthrough(boolean rawPassthrough) { this.rawPassthrough = rawPassthrough; }
