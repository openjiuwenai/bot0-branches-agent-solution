...
package com.openjiuwen.example.travel.hotel.prompt;
...
public final class SystemPromptBuilder {
     ...
     *
     * @return the rendered system prompt for today's date
     */
     ...
     *
     * @param today the date to inject as "today" into the prompt
     * @return the rendered system prompt for the given date
     */
