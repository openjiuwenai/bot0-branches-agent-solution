...
public final class GatewayRuntimeService implements IngressGateway {
    ...
    private static AgentBusEventType mapEventType(IngressEnvelope.IngressRequestType requestType, String routeHandle) {
        ...
        return switch (requestType) {
            case RUN_CREATE -> a2a ? AgentBusEventType.A2A_CALL_REQUESTED              : AgentBusEventType.CLIENT_INVOCATION_REQUESTED;
            case RUN_CANCEL -> a2a ? AgentBusEventType.A2A_CALL_CANCEL_REQUESTED       : AgentBusEventType.CLIENT_INVOCATION_CANCEL_REQUESTED;
            case RUN_GET    -> a2a ? AgentBusEventType.A2A_CALL_QUERY_REQUESTED        : AgentBusEventType.CLIENT_INVOCATION_QUERY_REQUESTED;
            case RUN_RESUME -> a2a ? AgentBusEventType.A2A_STREAM_SUBSCRIBE_REQUESTED  : AgentBusEventType.CLIENT_STREAM_SUBSCRIBE_REQUESTED;
        };
    }
