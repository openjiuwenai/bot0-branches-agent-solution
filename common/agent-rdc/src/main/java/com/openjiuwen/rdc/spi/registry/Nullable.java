 ...
 * ({@code agentName} / {@code agentType}) to signal that Method A populates
 * them while Method B leaves them {@code null} (ADR-0160 decision 2 / RB6).
 * REQ-2026-001 removed {@code systemProfile} + {@code toolSchemas} — the
 * A2A standard AgentCard now carries the equivalent metadata via
