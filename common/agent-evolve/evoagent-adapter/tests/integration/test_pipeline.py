...
class TestMultipleConversationIds:
    ...
    def test_separate_archives_per_conversation(self, adapter_dirs):
        ...
        log_file.write_text(
            ...
            + "\n"
            + make_start_line(call_id="uuid-002", conversation_id="conv-222", trace_id="trace-def")
            + "\n"
            + make_end_line(call_id="uuid-002", conversation_id="conv-222", trace_id="trace-def")
            + "\n"
...
class TestPidSwitch:
    ...
    def test_pid_switch_marks_pending_incomplete(self, adapter_dirs):
        ...
        new_file.write_text(
            make_start_line(call_id="uuid-002", conversation_id="conv-aaa", trace_id="trace-def")
            + "\n"
            + make_end_line(call_id="uuid-002", conversation_id="conv-aaa", trace_id="trace-def")
            + "\n",
            encoding="utf-8",
        )
